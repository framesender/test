...
global $Config ;
if ($_SESSION['u_name'] != '' and $_SESSION['u_log'] != '') $on = true;
else $on = false;
...
// Attention: The above 'UserFilesPath' must point to the same directory.   C:\\xampp\\htdocs\\work\\parkhotel_31.12.09\\files\\
