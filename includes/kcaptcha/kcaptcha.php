...
/*
if !empty($_SESSION['captcha_config'])
	{
		if $_SESSION['captcha_config'] == "login"  $config = '/kcaptcha_config.php';
	}
	
	else
	{
		$config = '/kcaptcha_config.php';
	}	
 */
...
class KCAPTCHA{
	...
	function KCAPTCHA(){
		...
		require(dirname(__FILE__).$_SESSION['captha_conf']);
		$fonts=array();
